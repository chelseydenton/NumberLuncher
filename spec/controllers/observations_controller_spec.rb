...
describe ObservationsController do
  ...
  let(:valid_attributes) { { "date_time" => "2014-04-01 18:57:25" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested observation" do
        ...
        Observation.any_instance.should_receive(:update).with({ "date_time" => "2014-04-01 18:57:25" })
        put :update, {:id => observation.to_param, :observation => { "date_time" => "2014-04-01 18:57:25" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the observation as @observation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Observation.any_instance.stub(:save).and_return(false)
        put :update, {:id => observation.to_param, :observation => { "date_time" => "invalid value" }}, valid_session
        assigns(:observation).should eq(observation)
      end
